...
final class GameScene: SKScene {
    ...
    func redraw() {
        ...
        for entity in entities {
            let sprite = SKSpriteNode(imageNamed: getIdleAnimationFirstFrameNameForEntity(entity))
            ...
            sprite.run(getAnimationFor(entity, lookRotation: entity.rotation))
            rootNode.addChild(sprite)
        }
    ...
    func getAnimationFor(_ entity: Entity, lookRotation: Rotation) -> SKAction {
